    ...
    <div class="content">
        <div class="container-fluid">
            ...
            elseif(isset($_GET['s'])&&$_GET['s']=="add_pt")
                echo '<h4 class="page-header"><a href="classes.php">Classes</a>-><a href="classes.php?s=cls_rec&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">'.displaySectionDesc($_GET['sid']).'('.displaySubjectDesc($_GET['subid']).')</a> -><a href="classes.php?s=add_grades&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">Add Grades</a>-> <a href="classes.php?s=pt&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">Performance Task</a>-> Add Performance Task</h4>';
            ...
            elseif(isset($_GET['s'])&&$_GET['s']=="add_qa")
                echo '<h4 class="page-header"><a href="classes.php">Classes</a>-><a href="classes.php?s=cls_rec&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">'.displaySectionDesc($_GET['sid']).'('.displaySubjectDesc($_GET['subid']).')</a> -><a href="classes.php?s=add_grades&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">Add Grades</a>-> <a href="classes.php?s=qa&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&yid='.$_GET['yid'].'">Quarterly Assessment</a>-> Add Quarterly Assessment</h4>';
