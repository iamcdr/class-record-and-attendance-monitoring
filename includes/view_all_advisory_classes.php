            ...
            <table class="table table-striped" id="content">
                ...
                <tbody>
                   <?php
                    ...
                    $queryClass = "SELECT * FROM teacher_classes WHERE teacher_id = {$_SESSION['hts_user_id']} AND year_id = {$schoolyear_id} AND archive_status = 0 AND advisory = 1";
                    ...
                    <tr>
                        ...
                        <td><a href="advisory.php?s=subj_list&sid=<?= $rowClass['section_id'] ?>&yid=<?= $rowClass['year_id'] ?>" class="btn btn-success">Open</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
