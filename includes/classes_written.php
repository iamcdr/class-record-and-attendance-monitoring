                        ...
                        <tr>
                            ...
                            //check if wwsession is available on table
                                ...
                                if(mysqli_num_rows($resultCounts)==0){
                                    if($totalFromOutAct!="")
                                        echo '<a href="classes.php?s=edit_ww&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&outses='.$output_session.'&yid='.$_GET['yid'].'">'."WW$i".'<i class="fa fa-pencil"></i></a>';
                                    else
                                        echo '<a href="classes.php?s=add_ww&sid='.$_GET['sid'].'&subid='.$_GET['subid'].'&outses='.$output_session.'&yid='.$_GET['yid'].'">'."WW$i".'<i class="fa fa-plus"></i></a>';
                                }else {
                                    echo "WW$i";
                                }
                            ?>
