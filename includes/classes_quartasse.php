    ...
    ?>
       <div class="row">
           <div class="col-lg-offset-4 col-lg-4">
               <a href="classes.php?s=qa_e&sid=<?= $_GET['sid']?>&subid=<?= $_GET['subid'] ?>&yid=<?= $_GET['yid'] ?>&gpid=<?= $gradingperiod_id?>" class="btn btn-primary btn-lg"><i class="fa fa-pencil"></i>Edit Grades</a>
           </div>
       </div>
